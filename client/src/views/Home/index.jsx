  ...
  <div className="home-container">
      <Form className="home-top" loading={loading}>
        ...
        <div className="home-links">
            <Link to='/about'>About</Link> | <a href="https://oak-bike.s3-us-west-1.amazonaws.com/LaneLookout+Privacy+Notice.pdf" rel="noopener noreferrer" target="_blank">Privacy Notice</a> | <a href="https://github.com/lanelookout/lanelookout" rel="noopener noreferrer" target="_blank">Source code</a> | <a href="https://www.gofundme.com/lanelookout" rel="noopener noreferrer" target="_blank">Support</a>
        </div>
      </Form>
          <Map
            center={center}
